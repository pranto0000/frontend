...
const TeacherAttendanceDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const studentRes = await axios.get("https://school-4ee7.onrender.com/api/studentsD");
        setStudents(studentRes.data.students || []);
        const attendanceRes = await axios.get("https://school-4ee7.onrender.com/api/today");
